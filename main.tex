...
Knickung nach Euler:\\
\includegraphics[width=7cm]{2-3-6_Knickfälle}
\begin{itemize}[leftmargin=*]
...
\begin{itemize}[leftmargin=*]
        ...
        \item [] $F_\text{Auftr.}=\rho_\text{Fl.}\cdot g\cdot V_\text{verdr.}$\tabto{3.3cm}...Vertikalkomponente (durch Schwp.)
...
\includegraphics[width=6cm]{4-3_Zustandsänderungen}
\begin{itemize}[leftmargin=*]
...
\begin{itemize}[leftmargin=*]
        \item [] \textbf{Dampfprozess:} (beispielhaft)\\\includegraphics[width=8cm]{4-6-1_Dampfprozess}
        \item [] \textbf{Kälteprozess:} (beispielhaft)\\\includegraphics[width=8cm]{4-6-1_Kälteprozess}
        \item [] \textbf{Joule-Prozess:}\\\includegraphics[width=6cm]{4-6-1_Joule-Prozess}
\end{itemize}
...
\begin{itemize}[leftmargin=*]
        ...
        \item [] $\quad\longrightarrow\quad C=\frac{A_e}{\sqrt{(\omega^2-\Omega^2)^2+4\cdot\delta^2\cdot\Omega^2}}$
        ...
        \item [] {\scriptsize wenn $\Omega=\omega_\text{max}\quad\rightarrow\quad$Resonanz}
\end{itemize}
